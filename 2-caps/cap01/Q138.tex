...
\opdiv[decimalsepsymbol={,},shiftdecimalsep=both,displayintermediary=all]{1}{5}\flexquad{3}
\opdiv[decimalsepsymbol={,},shiftdecimalsep=both,displayintermediary=all]{4}{5}\flexquad{3}
