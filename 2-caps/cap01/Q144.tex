...
\newcommand{\nodeRect}[2]{
    \draw [ color={rgb, 255:red, 255; green, 0; blue, 0 }  ,draw opacity=1 ] (A-#1-1.north west) -- (A-1-1.north east) -- (A-5-1.south east) -- (A-5-1.south west) -- cycle;
    \node [ below = of A-5-1.south] (A-5-1-s) {11};
    \draw [ color={rgb, 255:red, 255; green, 0; blue, 0 }  ,draw opacity=1, -> ]   (A-5-1.south) -- (A-5-1-s)  ; 
}
