...
\draw [ color={rgb, 255:red, 144; green, 19; blue, 254 }  ,draw opacity=1 ] (A-1-1.north west) -- (A-1-1.north east) -- (A-5-1.south east) -- (A-5-1.south west) -- cycle;

\draw [ color={rgb, 255:red, 144; green, 19; blue, 254 }  ,draw opacity=.3 ] (A-1-2.north west) -- (A-1-2.north east) -- (A-5-2.south east) -- (A-5-2.south west) -- cycle;
