...
\resizebox{.5\textwidth}{!}{
    ...
    % Text Node
    \draw (49,46) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {4 casas decimais até o };
    \draw (49,40) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {primeiro dígito significativo};
