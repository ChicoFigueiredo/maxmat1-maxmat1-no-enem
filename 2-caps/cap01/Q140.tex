...
\draw    (46.83,34) .. controls (62.27,42.69) and (70.26,42.99) .. (84.28,33.11) ;
\draw [shift={(85.83,32)}, rotate = 503.75] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;

% Text Node
\draw (28,15.4) node [anchor=north west][inner sep=0.75pt]    {$\ 0,00011\ =\ 1,1\ \cdot 10^{-4} \ $};
% Text Node
