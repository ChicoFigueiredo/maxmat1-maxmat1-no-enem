...
\noindent \resizebox{.5\textwidth}{!}{
    ...
    \draw [line width=2.25]    (55.83,55) .. controls (80.23,95.4) and (119.87,98.87) .. (162.86,67) ;
    \draw [shift={(135.5,55)}, rotate = 502.31] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=2.25]    (17.49,-5.26) .. controls (11.12,-2.23) and (5.29,-0.48) .. (0,0) .. controls (5.29,0.48) and (11.12,2.23) .. (17.49,5.26)   ;
