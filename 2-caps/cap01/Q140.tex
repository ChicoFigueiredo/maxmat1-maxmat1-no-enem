...
\noindent \resizebox{.5\textwidth}{!}{
    ...
    \draw [line width=2.25]    (56,55) .. controls (69.33,84.25) and (89.94,86.88) .. (116.91,53.63) ;
    \draw [shift={(119,51)}, rotate = 487.87] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=2.25]    (17.49,-5.26) .. controls (11.12,-2.23) and (5.29,-0.48) .. (0,0) .. controls (5.29,0.48) and (11.12,2.23) .. (17.49,5.26)   ;
    
    % Text Node
    \draw (24,18.4) node [anchor=north west][inner sep=0.75pt]  [font=\fontsize{2.59em}{3.11em}\selectfont]  {$\ 0,00011\ =\ 1,1\ \cdot 10^{-4} \ $};
    % Text Node
    \draw (60,84) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {4 casas decimais até o \\primeiro dígito significativo};
