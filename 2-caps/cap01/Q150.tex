...
\begin{wrapfigure}[5]{r}[0.10\textwidth]{0.10\textwidth}
    \begin{center}
        \href{https://youtu.be/S22SHYt4n-o}{
            \qrcode{https://youtu.be/S22SHYt4n-o}
        }
    \end{center}
\end{wrapfigure}Uma pessoa se interessou em adquirir um produto anunciado em uma loja. Negociou com o gerente e conseguiu comprá-lo a uma taxa de juros compostos de 1\% ao mês. O primeiro pagamento será um mês após a aquisição do produto, e no valor de R\$ 202,00.
