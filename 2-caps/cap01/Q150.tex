...
\noindent \resizebox{.5\textwidth}{!}{
    ...
    % Text Node
    \draw (202.3,206.74) node [anchor=north west][inner sep=0.75pt]  [font=\LARGE]  {$202,00$};
    % Text Node
    \draw (376.62,202.37) node [anchor=north west][inner sep=0.75pt]  [font=\LARGE]  {$204,02$};
    % Text Node
    \draw (10.56,201.24) node [anchor=north west][inner sep=0.75pt]  [font=\Large]  {$202,00\ \div \ 1,01 \ $};
    % Text Node
    \draw (63.16,260.77) node [anchor=north west][inner sep=0.75pt]  [font=\Large]  {$204,02\ \div \ 1,01^{2} \ $};
    % Text Node
