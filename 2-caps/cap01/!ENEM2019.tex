...
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
    ...
    \draw    (261,115.5) -- (261,170.5) ;
    \draw [shift={(261,172.5)}, rotate = 270] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
    %Straight Lines [id:da3516868561588282] 
    \draw [color={rgb, 255:red, 245; green, 166; blue, 35 }  ,draw opacity=1 ][fill={rgb, 255:red, 245; green, 166; blue, 35 }  ,fill opacity=1 ]   (134,176.5) -- (29,176.5) ;
    \draw [shift={(27,176.5)}, rotate = 360] [color={rgb, 255:red, 245; green, 166; blue, 35 }  ,draw opacity=1 ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
    %Straight Lines [id:da13727046886374206] 
    \draw [color={rgb, 255:red, 245; green, 166; blue, 35 }  ,draw opacity=1 ][fill={rgb, 255:red, 245; green, 166; blue, 35 }  ,fill opacity=1 ]   (262,204) -- (31,204) ;
    \draw [shift={(29,204)}, rotate = 360] [color={rgb, 255:red, 245; green, 166; blue, 35 }  ,draw opacity=1 ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
    ...
    % Text Node
    \draw (44,177.9) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$202\ \div \ 1,01 \ $};
    % Text Node
    \draw (99,208.4) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$204,02\ \div \ 1,01^{2} \ $};
    % Text Node
